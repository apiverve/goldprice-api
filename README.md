...
async function callGoldPriceAPI() {
    try {
        ...
        const response = await fetch(`https://api.apiverve.com/v1/goldprice?${params}`, {
            method: 'GET',
            headers: {
...
```bash
curl -X GET "https://api.apiverve.com/v1/goldprice?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/goldprice](https://docs.apiverve.com/ref/goldprice)

---

## Use Cases

Common use cases for the Gold Price API:
