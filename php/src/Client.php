 ...
 * ```
 *
 * @see https://goldprice.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/goldprice';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GoldpriceClient] {$message}\n";
        }
    }
}
