...
```gradle
dependencies {
    implementation 'com.github.apiverve:goldprice-api:1.1.12'
}
```
...
```java
import com.apiverve.goldprice.GoldPriceAPIClient;
import com.apiverve.goldprice.APIResponse;
import com.apiverve.goldprice.APIException;

// Initialize the client
GoldPriceAPIClient client = new GoldPriceAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/goldprice](https://docs.apiverve.com/ref/goldprice)
...
- **Documentation:** [https://docs.apiverve.com/ref/goldprice](https://docs.apiverve.com/ref/goldprice)
- **Issues:** [GitHub Issues](https://github.com/apiverve/goldprice-api/issues)
