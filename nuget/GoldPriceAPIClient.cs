...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/goldprice";
        ...
        public GoldPriceAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GoldPriceAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GoldPriceAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GoldPriceQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GoldPriceQueryOptions options)
        {
        ...
        public ResponseObj Execute(GoldPriceQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GoldPriceQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GoldPriceQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GoldPriceQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GoldPriceQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GoldPriceQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GoldPriceQueryOptions options)
        {
