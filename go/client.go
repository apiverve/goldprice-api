// Package goldprice provides a Go client for the Gold Price API.
//
// For more information, visit: https://goldprice.apiverve.com?utm_source=go&utm_medium=readme
package goldprice
...
const (
	baseURL        = "https://api.apiverve.com/v1/goldprice"
	defaultTimeout = 30 * time.Second
)

// Client is the Gold Price API client.
type Client struct {
	apiKey     string
...
// Execute makes a request to the Gold Price API with typed parameters.
//
